...
// Country dial codes for the phone field. Greece first (the default), then
// the countries our customers most commonly travel from. The selected dial
// code is prepended to the number on submit so passenger_phone lands in the
// bookings table already dialable (e.g. "+30 6936475451").
const COUNTRIES = [
  { f: '🇬🇷', n: 'Greece', d: '+30' },
